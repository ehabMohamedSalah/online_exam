...
import '../../domain/usecase/auth_usecase/forget_password_usecase.dart' as _i43;
import '../../domain/usecase/auth_usecase/login_usecase.dart' as _i41;
import '../../domain/usecase/auth_usecase/reset_password.dart' as _i49;
import '../../domain/usecase/auth_usecase/signup_usecase.dart' as _i46;
import '../../domain/usecase/auth_usecase/verify_usecase.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i39.ProfileScreenViewModelCubit>(
        () => _i39.ProfileScreenViewModelCubit(gh<_i32.ProfileInfoUsecase>()));
    gh.factory<_i40.NewPasswordViewModelCubit>(
        () => _i40.NewPasswordViewModelCubit(gh<_i22.ChangePasswordUsecase>()));
    gh.factory<_i41.LoginUseCase>(() => _i41.LoginUseCase(gh<_i36.AuthRepo>()));
    gh.factory<_i42.VerifyUsecase>(
        () => _i42.VerifyUsecase(gh<_i36.AuthRepo>()));
    gh.factory<_i43.ForgetPasswordUsecase>(
        () => _i43.ForgetPasswordUsecase(gh<_i36.AuthRepo>()));
    gh.factory<_i44.ScoreViewModelCubit>(
        () => _i44.ScoreViewModelCubit(gh<_i34.CheckQuestionUsecase>()));
    gh.factory<_i45.VerificationViewModelCubit>(
        () => _i45.VerificationViewModelCubit(gh<_i42.VerifyUsecase>()));
    gh.factory<_i46.SignupUsecase>(
        () => _i46.SignupUsecase(gh<_i36.AuthRepo>()));
    gh.factory<_i47.SignupViewModelCubit>(
        () => _i47.SignupViewModelCubit(gh<_i46.SignupUsecase>()));
    gh.factory<_i48.SubjectOnExamCubit>(
        () => _i48.SubjectOnExamCubit(gh<_i33.ExamOnsubjectUsecase>()));
    gh.factory<_i49.ResetPasswordUsecase>(
        () => _i49.ResetPasswordUsecase(gh<_i36.AuthRepo>()));
    gh.factory<_i50.LoginViewModelCubit>(
        () => _i50.LoginViewModelCubit(gh<_i41.LoginUseCase>()));
    gh.factory<_i51.ForgetPasswordViewModelCubit>(() =>
        _i51.ForgetPasswordViewModelCubit(gh<_i43.ForgetPasswordUsecase>()));
    gh.factory<_i52.ResetPasswordViewModelCubit>(() =>
        _i52.ResetPasswordViewModelCubit(gh<_i49.ResetPasswordUsecase>()));
    return this;
  }
}
